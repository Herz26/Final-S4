...
<head>
    ...
    <title>Comptes - Mobile Money</title>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="/operator/comptes" class="list-group-item list-group-item-action active">Situation des comptes</a>
