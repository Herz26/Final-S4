...
<head>
    ...
    <title>Montants à envoyer - Mobile Money</title>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="/operator/settlements" class="list-group-item list-group-item-action active">Montants à envoyer</a>
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                        <h4>Situation des montants à envoyer à chaque opérateur</h4>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Envoyé (Ar)</th>
                                    <th>Reçu (Ar)</th>
                                    <th>Net à envoyer (Ar)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($settlements as $settlement): ?>
                                    <tr>
                                        <td><?= $settlement['operator_name'] ?></td>
                                        <td><?= number_format($settlement['outgoing'], 0, ',', ' ') ?></td>
                                        <td><?= number_format($settlement['incoming'], 0, ',', ' ') ?></td>
                                        <td class="<?= $settlement['net'] > 0 ? 'text-danger' : 'text-success' ?>">
                                            <?= number_format($settlement['net'], 0, ',', ' ') ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
